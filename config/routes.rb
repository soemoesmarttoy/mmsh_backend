Rails.application.routes.draw do
  ...
  post "cash-transfer/create-pre-paid", to: "orders#create_pre_paid"
  post "cash-transfer/create-pre-received", to: "orders#create_pre_received"
  delete "delete-orders/delete-sell(/:id)", to: "delete_orders#delete_sell"
  ...
  delete "pre_sells(/:id)", to: "pre_sells#delete_pre_sell"
  ...
  post "create-settle-to-receive-order-by-to-pay", to: "orders#settle_to_receive_by_to_pay"
